using System;
using Gwupe.Agent.Components.Functions.FileSend.Processors;
using Gwupe.Agent.Components.Functions.RemoteDesktop.Processors;
using Gwupe.Agent.Components.Processors;
using log4net;
using ChatMessageProcessor = Gwupe.Agent.Components.Functions.Chat.Processors.ChatMessageProcessor;
